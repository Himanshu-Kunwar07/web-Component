...
const select1= document.querySelector("#hour");
hour.forEach((i) =>{
...
const select2 = document.querySelector("#minute");
...
const generateCalendar = (month, year)=>{
    ...
    let day_of_month = [31, getFebDays(year), 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
